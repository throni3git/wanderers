...
export class MeshLine {
	...
	setGeometry = function (g: THREE.Geometry| THREE.BufferGeometry, callback?: (p: number) => number) {
...
fragmentShader;
	...
	constructor(parameters) {
		...
		// var material = new THREE.RawShaderMaterial({
			...
			this.vertexShader = this.vertexShaderSource.join('\r\n'),
			this.fragmentShader = this.fragmentShaderSource.join('\r\n')
		// });
